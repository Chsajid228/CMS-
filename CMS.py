...
─────────────────────────  
  ...
  \033[1;91m:》》》\033[1;93m+923137282905\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-CMS Hacker-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Abid Ch......................
\033[1;93m Apun Ka Name Hi Kaffi Hai.
\033[1;93m www.Facebook.com/Muhammadsajid228
\033[1;93m www.Facebook.com/muhammadsajidofficial228
\033[1;93m
\033[1;95m⊱⋅ ──────────── ⋅⊰jalan("\033[1;96mHumiKhan\033[1;95m"⊱⋅ ──────────── ⋅⊰""
...
print  """
 ...
 \033[1;96m ────────────────  ─────── ─────────────•◈•──────────  
   jalan("\033[1;92m███████▒▒ ꧁༺🅼🅸🅰🅽 🅰🅱🅸🅳༻꧂𖤍▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mMIANABID\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mSajidch
\033[1;94mDevolper\033[1;91m: \033[1;91▒꧁༺🅼🅸🅰🅽 🅰🅱🅸🅳༻꧂𖤍 ]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mAbidch03124271911
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923124271911
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mHumikhan\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................CMS.....................:')
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin CMS Hacker\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "CMSHacker"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as  CMS Hacker" + username #Dev:Mian_Abid
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open 
            https://m.facebook.com/Abidch03124271911')
    else:
        print "\033[1;94mWrong Username"
        os.system('xdg-open https://m.facebook.com/Abidch03124271911')
...
def login():
	...
	try:
		...
		os.system('clear')
		print logo
		jalan(' \033[1;92mAttation plz: \033[1;97mDo Not Use Your Personal id. Use A New Fresh Id' )
		jalan(' \033[1;92m   Note: \033[1;97mUse a New Account To Login' )
		print "\033[1;95m❈-❈-❈-❈-❈-❈-❈-❈\033[1;96mHumikhan\033[1;95m❈-❈-❈-❈-❈-❈-❈-❈"
		print('	   \033[1;94m♡\x1b[1;91m❍❍❍❖❍❍❍LOGIN WITH FACEBOOK NEW ACCOUNT❍❍❍❖❍❍❍\x1b[1;94m♡' )
		print('	' )
		id = raw_input('\033[1;96m[+] \x1b[1;92mUse Fresh ID/Email\x1b[1;95m: \x1b[1;96m')
		pwd = raw_input('\033[1;96m[+] \x1b[1;93mType id Password\x1b[1;96m: \x1b[1;96m')
		tik()
		try:
		...
		if 'checkpoint' in url:
			...
			print("\n\x1b[1;93mPassword/Email Is Wrong... Dobra Try kry")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;91mBRO/SIS Your Id Is On CheckPoint. Use A New Fresh Id"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
	...
	print "\033[1;95m❏ ❐ ❑ ❒ ❏ ❐ ❏ ❐ ❑ ❒ ❏ ❐\033[1;96mMian Abid\033[1;95m❏ ❐ ❑ ❒ ❏ ❐ ❏ ❐ ❑ ❒ ❏ ❐"
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;95m♡✧══════•❁❀❁•══════✧\033[1;96mMianAbid\033[1;95m✧══════•❁❀❁•══════✧"
		try:
	...
	print "\033[1;95m◆━━━━━━━▣✦▣━━━━━━━━◆\033[1;96mHumiKhan\033[1;95m◆━━━━━━━▣✦▣━━━━━━━━◆
	jalan(' \033[1;93m ........Cloning Shru Ho chuki Ha Wait Kro.......... ')
	print "\033[1;95m*╔═══❖•ೋ° °ೋ•❖═══╗*\033[1;96mMianAbid\033[1;95m*╚═══❖•ೋ° °ೋ•❖═══╝*"
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mMian\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By CMS---•◈•---»" #Dev:love_hacker
...
┗╗┏╣┃┃║┃
   ┗╝┗═┻═╝
       ...
       ┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬
: \033[1;96m Chaudhry Muhammad Sajid........... \033[1;93m :
  ┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬┴┬
                MY WHATSAPP CONTECT FOR MORE INFO
               +923137382905"""
